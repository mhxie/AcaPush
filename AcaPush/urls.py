...
urlpatterns = [
	 ...
	 url(r'^search/(\d{1})/(\w{1,15})/(\d{2})/(\d{8})/$', search, name='search'), #search the news or notice(flag==0 or flag==1) with keyword（w{1,15}) (00 or 00000000 will return all academy and date news)
]
